...
export const metadata: Metadata = {
    title: "Sonic Drilling - Summit Drilling, LLC",
    description: "Advanced sonic drilling technology for continuous, undisturbed core samples through any geological formation.",
};
