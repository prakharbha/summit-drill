...
export const metadata: Metadata = {
    title: "Hollow Stem Auger Drilling - Summit Drilling, LLC",
    description: "Auger drilling for shallow boreholes in unconsolidated formations. Ideal when soil sampling is required during borehole advancement.",
};
