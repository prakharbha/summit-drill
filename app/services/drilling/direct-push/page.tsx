...
export const metadata: Metadata = {
    title: "Direct Push Drilling - Summit Drilling, LLC",
    description: "Fast, efficient direct push drilling for soil, groundwater and vapor sampling with minimal site impact.",
};
