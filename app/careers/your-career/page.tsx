                    ...
                    <div className="container mx-auto px-4 lg:px-8">
                        <div className="max-w-4xl">
                            <div className="space-y-6 text-lg text-[#1A365D] leading-relaxed font-medium">
                                ...
                                <p>
                                    Our programs are comprehensive and designed to support our people in their advancement. For example, we offer unique internal trainings that include a Driller Apprentice Training Program that includes a comprehensive list of health and safety programs and equipment operating licensure opportunities, such as CDLs, OSHA Safety Certifications, heavy machinery, drilling licenses and more. This ensures that our teams are well trained and prepared for successful outcomes and a rewarding career path.
                                </p>
