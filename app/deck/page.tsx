...
// CSS-in-JS styles matching the HTML reference exactly
const styles = `
...
.timeline-section {
    ...
    padding: 30px;
    border-radius: 20px;
    background: linear-gradient(135deg, var(--summit-blue), #00246d);
...
.page-footer {
    ...
    right: 0;
    height: 50px;
    background: linear-gradient(90deg, var(--summit-blue), var(--summit-red));
    display: flex;
    justify-content: space-between;
    align-items: center;
    padding: 0 40px;
    ...
    return (
        <>
            ...
            <div className="deck-container">
                ...
                <div className="page" style={{ padding: '60px' }}>
                ...
                {/* Page 3: Mission, Vision & Values */}
                <div className="page" style={{ height: '11in', maxHeight: '11in', overflow: 'hidden', padding: '30px 40px', background: 'linear-gradient(to bottom, #ffffff 0%, #f8f9fa 100%)' }}>
                ...
                {/* Page 4: Who We Are */}
                <div className="page" style={{ padding: '60px', position: 'relative' }}>
                    <div className="page-header">
                        <h2 className="page-title">Who We Are</h2>
                        <p className="page-subtitle">Built on Trust</p>
                    </div>
                ...
                < div className="page" style={{ padding: '60px', background: 'linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%)' }}>
                    <div className="page-header">
                    ...
                    <div className="services-grid">
                        <div className="service-card">
                            ...
                            <div className="service-content">
                                ...
                                <div className="service-features">
                                    ...
                                    <div className="feature-item">Sonic, Mud Rotary, Hollow-Stem Auger, Air Rotary</div>
                                    <div className="feature-item">Rock Coring And Probe-Push Tooling</div>
                                    <div className="feature-item">Limited-Access And Remote Terrain Drilling</div>
                                    <div className="feature-item">Hydropunch And Packer Testing</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="service-card">
                            ...
                            <div className="service-content">
                                ...
                                <div className="service-features">
                                    <div className="features-title">Features</div>
                                    <div className="feature-item">Direct-Push And Pneumatic Injection Systems</div>
                                    <div className="feature-item">In-Situ Chemical Oxidation (ISCO) And Reduction (ISCR)</div>
                                    <div className="feature-item">High-Resolution Emplacement Strategies</div>
                                    <div className="feature-item">Feasibility Testing And Pilot Studies</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                < div className="page" style={{ padding: '40px 50px' }}>
                    <div className="services-grid">
                        <div className="service-card">
                            ...
                            <div className="service-content">
                                ...
                                <div className="service-features">
                                    <div className="features-title">Features</div>
                                    <div className="feature-item">Dedicated PFAS-Only Tooling Kits</div>
                                    <div className="feature-item">No-Teflon, PTFE-Free Materials</div>
                                    <div className="feature-item">Crew Training In AFFF-Free Decon</div>
                                    <div className="feature-item">QA/QC Documentation</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="service-card">
                            ...
                            <div className="service-content">
                                ...
                                <div className="service-features">
                                    <div className="features-title">Features</div>
                                    <div className="feature-item">Borehole Geophysics: Caliper, Gamma, Optical</div>
                                    <div className="feature-item">Electrical Resistivity And Seismic Refraction</div>
                                    <div className="feature-item">Underground Storage Tank (UST) Detection</div>
                                    <div className="feature-item">Utility And Septic Line Mapping</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ marginTop: '15px', borderRadius: '15px', overflow: 'hidden', boxShadow: '0 10px 40px rgba(0, 0, 0, 0.08)' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0' }}>
                            <div style={{ background: 'white' }}>
                                <div className="service-header" style={{ background: 'rgba(200, 16, 46, 0.9)', padding: '15px 20px', display: 'flex', alignItems: 'center' }}>
                                ...
                                <div className="service-content" style={{ padding: '15px 20px' }}>
                                    <p className="service-description" style={{ fontSize: '12px', marginBottom: '10px', lineHeight: 1.5, color: '#444' }}>
                                    ...
                                    <div className="service-features">
                                        <div className="features-title" style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: '#c8102e', marginBottom: '5px' }}>Features</div>
                                        <div className="feature-item" style={{ fontSize: '11px', marginBottom: '2px', paddingLeft: '10px', display: 'flex', alignItems: 'center' }}>
                                            <span style={{ color: '#c8102e', marginRight: '6px' }}>•</span>CPT And SPT Sampling
                                        </div>
                                        <div className="feature-item" style={{ fontSize: '11px', marginBottom: '2px', paddingLeft: '10px', display: 'flex', alignItems: 'center' }}>
                                            <span style={{ color: '#c8102e', marginRight: '6px' }}>•</span>Rock Coring (BQ, NQ, HQ, PQ)
                                        </div>
                                        <div className="feature-item" style={{ fontSize: '11px', marginBottom: '2px', paddingLeft: '10px', display: 'flex', alignItems: 'center' }}>
                                            <span style={{ color: '#c8102e', marginRight: '6px' }}>•</span>Instrumentation Installation
                                        </div>
                                        <div className="feature-item" style={{ fontSize: '11px', marginBottom: '2px', paddingLeft: '10px', display: 'flex', alignItems: 'center' }}>
                                            <span style={{ color: '#c8102e', marginRight: '6px' }}>•</span>Packer Testing
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="page" style={{ padding: '48px 56px 50px', background: 'linear-gradient(160deg, #ffffff 0%, #f4f6f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '22px', alignItems: 'start' }}>
                        <div>
                            ...
                            <p style={{ fontSize: '14px', lineHeight: 1.6, color: 'var(--medium-gray)', marginBottom: '12px' }}>This specialized team offers advanced geophysical surveys and underground utility mapping to de-risk drilling and provide key subsurface insights.</p>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}><span style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span><span style={{ fontSize: '14px', color: 'var(--dark-gray)', fontWeight: 500 }}>Borehole Logging And Stratigraphic Profiling</span></div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}><span style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span><span style={{ fontSize: '14px', color: 'var(--dark-gray)', fontWeight: 500 }}>Utility And UST Detection</span></div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}><span style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span><span style={{ fontSize: '14px', color: 'var(--dark-gray)', fontWeight: 500 }}>Seismic And Resistivity Imaging</span></div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '9px' }}><span style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span><span style={{ fontSize: '14px', color: 'var(--dark-gray)', fontWeight: 500 }}>Pre-Drilling Clearance And Documentation</span></div>
                            </div>
                        </div>
                ...
                {/* Page 8: Acquisitions */}
                < div className="page" style={{ padding: '48px 56px 50px', background: '#fff', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <p style={{ fontSize: '12.5px', lineHeight: 1.6, color: 'var(--medium-gray)', marginBottom: '24px', maxWidth: '90%' }}>Summit's growth is driven by more than investment — it's rooted in integration. The following acquisitions have strengthened our geographic presence and deepened our technical bench:</p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', borderRadius: '16px', overflow: 'hidden', background: 'rgba(0,48,135,0.03)', border: '1px solid rgba(0,48,135,0.10)', boxShadow: '0 4px 18px rgba(0,0,0,0.06)' }}>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--dark-gray)', marginBottom: '5px' }}>TPI Environmental <span style={{ color: 'var(--medium-gray)', fontWeight: 400, fontSize: '13.5px' }}>(NJ)</span></h3>
                                ...
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55 }}>Enhanced regional reach and expanded geotechnical capabilities.</p>
                            </div>
                        </div>
                        {/* SET */}
                        <div style={{ display: 'flex', flexDirection: 'column', borderRadius: '16px', overflow: 'hidden', background: 'rgba(200,16,46,0.03)', border: '1px solid rgba(200,16,46,0.10)', boxShadow: '0 4px 18px rgba(0,0,0,0.06)' }}>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--dark-gray)', marginBottom: '5px' }}>Subsurface Env. Technologies <span style={{ color: 'var(--medium-gray)', fontWeight: 400, fontSize: '13.5px' }}>(PA)</span></h3>
                                <div style={{ width: '42px', height: '3px', background: 'linear-gradient(90deg, var(--summit-blue), var(--summit-red))', borderRadius: '3px', marginBottom: '7px' }}></div>
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55 }}>Injection and overburden/bedrock drilling capacity.</p>
                            </div>
                        </div>
                        {/* Hill */}
                        <div style={{ display: 'flex', flexDirection: 'column', borderRadius: '16px', overflow: 'hidden', background: 'rgba(0,48,135,0.03)', border: '1px solid rgba(0,48,135,0.10)', boxShadow: '0 4px 18px rgba(0,0,0,0.06)' }}>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--dark-gray)', marginBottom: '5px' }}>Hill Environmental Group <span style={{ color: 'var(--medium-gray)', fontWeight: 400, fontSize: '13.5px' }}>(NY)</span></h3>
                                <div style={{ width: '42px', height: '3px', background: 'linear-gradient(90deg, var(--summit-blue), var(--summit-red))', borderRadius: '3px', marginBottom: '7px' }}></div>
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55 }}>Strengthened environmental drilling and site investigation services.</p>
                            </div>
                        </div>
                        {/* SAEDACCO */}
                        <div style={{ display: 'flex', flexDirection: 'column', borderRadius: '16px', overflow: 'hidden', background: 'rgba(200,16,46,0.03)', border: '1px solid rgba(200,16,46,0.10)', boxShadow: '0 4px 18px rgba(0,0,0,0.06)' }}>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--dark-gray)', marginBottom: '5px' }}>SAEDACCO <span style={{ color: 'var(--medium-gray)', fontWeight: 400, fontSize: '13.5px' }}>(SC)</span></h3>
                                <div style={{ width: '42px', height: '3px', background: 'linear-gradient(90deg, var(--summit-blue), var(--summit-red))', borderRadius: '3px', marginBottom: '7px' }}></div>
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55 }}>Deep experience in injection, remediation, and barge-access drilling in the Southeast U.S.</p>
                            </div>
                        </div>
                    </div>

                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginTop: '20px', fontStyle: 'italic' }}>Each of these teams now operates as part of Summit Drilling, aligned under a single culture of safety, ownership, and client-first performance.</p>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: 'linear-gradient(160deg, #fff 0%, #f2f5f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 0.82fr', gap: '24px', alignItems: 'start' }}>
                        <div>
                            <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '17px', color: 'var(--summit-red)', marginBottom: '5px' }}>Environmental & Geotechnical Drilling</h3>
                            <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.5, marginBottom: '12px' }}>We offer a broad range of drilling methods and configurations, matched to your site's geology, access limitations, and investigation needs.</p>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                {['Sonic Drilling (track and truck-mounted)', 'Mud Rotary / Hollow-Stem Auger', 'Direct Push / Geoprobe Tooling', 'Air Rotary & Rock Coring', 'Probe-Push and Limited Access Drilling', 'Groundwater Monitoring Well Installation', 'Soil Vapor / Soil / Groundwater Sampling', 'SPT, CPT, and Geotechnical Sampling'].map((item, i) => (
                                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '9px', background: 'rgba(0,48,135,0.04)', borderRadius: '9px', padding: '8px 13px' }}>
                                        <span style={{ width: '20px', height: '20px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: '#fff', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ maxWidth: 'calc(100% - 275px)' }}>
                        <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '19px', color: 'var(--summit-red)', marginBottom: '5px' }}>Site Characterization & Utility Clearance</h3>
                        <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55, marginBottom: '12px' }}>Our geophysical and utility locating services reduce risk and improve project efficiency by providing actionable data before drilling begins.</p>
                        ...
                        <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '19px', color: 'var(--summit-red)', marginBottom: '5px' }}>Remediation & Injection Implementation</h3>
                        <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.55, marginBottom: '12px' }}>Our in-house injection teams are trained in advanced chemical delivery methods and supported by real-time monitoring and QA/QC.</p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                < div className="page" style={{ padding: 0, background: '#fff', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                    <div style={{ padding: '44px 56px 24px', flexShrink: 0 }}>
                        <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '21px', color: 'var(--summit-red)', marginBottom: '5px' }}>PFAS Drilling Protocols</h3>
                        <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '16px' }}>We follow strict contamination control procedures designed for sensitive PFAS and emerging contaminant sites.</p>
                        ...
                        <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginTop: '16px', fontStyle: 'italic' }}>Summit's integrated service model gives our clients the advantage of centralized communication, streamlined coordination, and consistent quality, from planning to fieldwork to reporting.</p>
                    </div>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: 'linear-gradient(160deg, #fff 0%, #f4f6f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ marginBottom: '12px' }}>
                    ...
                    <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '17px', color: 'var(--summit-red)', marginBottom: '12px' }}>Summit at a glance</h3>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '20px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '155px 1fr', gap: '18px', alignItems: 'center', padding: '14px', borderRadius: '16px', background: 'rgba(0,48,135,0.04)', border: '1px solid rgba(0,48,135,0.08)' }}>
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.5 }}>Field crews, drillers, injection specialists, safety personnel, and project managers.</p>
                            </div>
                        </div>
                        <div style={{ display: 'grid', gridTemplateColumns: '155px 1fr', gap: '18px', alignItems: 'center', padding: '14px', borderRadius: '16px', background: 'rgba(200,16,46,0.03)', border: '1px solid rgba(200,16,46,0.08)' }}>
                            ...
                            <div>
                                ...
                                <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.5 }}>Operating across the East Coast from Massachusetts to Georgia, and west through Tennessee and Alabama.</p>
                            </div>
                        </div>
                    </div>

                    <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '17px', color: 'var(--summit-red)', marginBottom: '5px' }}>Fleet Capabilities</h3>
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', marginBottom: '10px' }}>Our modern fleet includes:</p>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                {['Sonic Drilling (Track And Truck-Mounted)', 'Hollow-Stem Auger', 'Mud Rotary', 'Air Rotary', 'Direct Push / Geoprobe', 'Limited Access Tooling', 'Barge-Access Equipment'].map((item, i) => (
                                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: 'linear-gradient(160deg, #fff 0%, #f4f6f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '14px' }}>At Summit Drilling, sustainability begins with how we operate — safely, responsibly, and with long-term relationships in mind. We believe our most valuable assets don't roll in on rigs. They show up every day ready to own their work.</p>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '10px' }}>Summit's <strong style={{ color: 'var(--summit-blue)' }}>Driller Apprentice Training Program</strong> is designed to build skilled professionals from the ground up. Apprentices receive hands-on mentoring, safety training, and equipment experience.</p>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '7px' }}>
                        {['Structured Learning And Certifications', 'Mentorship From Senior Drillers', 'Career Progression For Both Field And Leadership Roles'].map((item, i) => (
                            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '9px' }}>
                                <span style={{ width: '18px', height: '18px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span>
                                <span style={{ fontSize: '14px', color: 'var(--dark-gray)', fontWeight: 500 }}>{item}</span>
                            </div>
                        ))}
                    </div>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: '#fff', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '28px' }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '18px' }}>We actively recruit military veterans for their discipline, problem-solving skills, and field-readiness. Our crews thrive on clear leadership, respect, and mission-focused work.</p>

                            <h3 style={{ fontFamily: 'Poppins, sans-serif', fontSize: '18px', color: 'var(--summit-blue)', fontWeight: 700, marginBottom: '10px' }}>
                                Benefits & Workplace Culture
                            </h3>
                            <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '18px' }}>We offer competitive benefits, 401(K), PTO, and professional development because we want our team to grow with us.</p>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginTop: '20px', fontStyle: 'italic', textAlign: 'center' }}>We don't just show up to drill. We show up to help you protect the environment, support your data integrity, and bring your project across the finish line.</p>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: 'linear-gradient(160deg, #fff 0%, #f4f6f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '16px' }}>Summit Drilling has supported thousands of drilling and remediation projects across the Eastern U.S.</p>

                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        {/* Case 1 */}
                        <div style={{ borderRadius: '18px', overflow: 'hidden', background: '#fff', boxShadow: '0 6px 28px rgba(0,0,0,0.08)', border: '1px solid rgba(0,48,135,0.07)' }}>
                            <div style={{ position: 'relative' }}>
                                <div style={{ background: 'var(--dark-gray)', borderRadius: '8px', padding: '5px 12px', display: 'inline-block', position: 'absolute', top: '12px', left: '12px', zIndex: 2 }}><span style={{ fontSize: '10px', color: '#fff', fontWeight: 700, letterSpacing: '0.5px' }}>CASE STUDY - 1</span></div>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--summit-red)', marginBottom: '7px' }}>PFAS Site Characterization</h3>
                                <p style={{ fontSize: '13px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '10px' }}><strong style={{ color: 'var(--dark-gray)' }}>Scope:</strong> Environmental drilling under strict QA/QC controls using dedicated PFAS-only tooling.</p>
                                <p style={{ fontSize: '13.5px', color: 'var(--summit-red)', fontWeight: 700, marginBottom: '6px' }}>Results</p>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                    {['20+ Wells Installed', 'Zero Cross-Contamination Events', 'All Client Sampling Targets Met'].map((item, i) => (
                                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '7px' }}><span style={{ width: '14px', height: '14px', borderRadius: '50%', background: 'var(--summit-red)', flexShrink: 0 }}></span><span style={{ fontSize: '13px', color: 'var(--dark-gray)' }}>{item}</span></div>
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ borderRadius: '18px', overflow: 'hidden', background: '#fff', boxShadow: '0 6px 28px rgba(0,0,0,0.08)', border: '1px solid rgba(0,48,135,0.07)' }}>
                            <div style={{ position: 'relative' }}>
                                <div style={{ background: 'var(--dark-gray)', borderRadius: '8px', padding: '5px 12px', display: 'inline-block', position: 'absolute', top: '12px', left: '12px', zIndex: 2 }}><span style={{ fontSize: '10px', color: '#fff', fontWeight: 700, letterSpacing: '0.5px' }}>CASE STUDY - 2</span></div>
                                <div style={{ height: '150px', overflow: 'hidden' }}><img src="/images/remediation/injection-banner.webp" alt="Superfund" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /></div>
                                <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '50px', background: 'linear-gradient(transparent, rgba(0,0,0,0.6))' }}></div>
                            ...
                            <div style={{ padding: '16px 18px 18px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '14px', color: 'var(--summit-red)', marginBottom: '7px' }}>High-Volume Injection For Groundwater Remediation</h3>
                                <p style={{ fontSize: '13px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '10px' }}><strong style={{ color: 'var(--dark-gray)' }}>Scope:</strong> Direct-push injections across a multi-acre plume zone.</p>
                                <p style={{ fontSize: '13.5px', color: 'var(--summit-red)', fontWeight: 700, marginBottom: '6px' }}>Results</p>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: '#fff', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        ...
                        <div style={{ borderRadius: '18px', overflow: 'hidden', background: '#fff', boxShadow: '0 6px 28px rgba(0,0,0,0.08)', border: '1px solid rgba(0,48,135,0.07)' }}>
                            <div style={{ position: 'relative' }}>
                                <div style={{ background: 'var(--dark-gray)', borderRadius: '8px', padding: '5px 12px', display: 'inline-block', position: 'absolute', top: '12px', left: '12px', zIndex: 2 }}><span style={{ fontSize: '10px', color: '#fff', fontWeight: 700, letterSpacing: '0.5px' }}>CASE STUDY - 3</span></div>
                            ...
                            <div style={{ padding: '18px 18px 20px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '15px', color: 'var(--summit-red)', marginBottom: '8px' }}>Urban Utility Clearance + Sonic Drilling</h3>
                                <p style={{ fontSize: '13px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '12px' }}><strong style={{ color: 'var(--dark-gray)' }}>Scope:</strong> Geophysical utility locating and UST detection across a dense urban site.</p>
                                <p style={{ fontSize: '13.5px', color: 'var(--summit-red)', fontWeight: 700, marginBottom: '6px' }}>Results</p>
                        ...
                        <div style={{ borderRadius: '18px', overflow: 'hidden', background: '#fff', boxShadow: '0 6px 28px rgba(0,0,0,0.08)', border: '1px solid rgba(0,48,135,0.07)' }}>
                            <div style={{ position: 'relative' }}>
                                <div style={{ background: 'var(--dark-gray)', borderRadius: '8px', padding: '5px 12px', display: 'inline-block', position: 'absolute', top: '12px', left: '12px', zIndex: 2 }}><span style={{ fontSize: '10px', color: '#fff', fontWeight: 700, letterSpacing: '0.5px' }}>CASE STUDY - 4</span></div>
                            ...
                            <div style={{ padding: '18px 18px 20px' }}>
                                <h3 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '15px', color: 'var(--summit-red)', marginBottom: '8px' }}>Barge-Access Drilling For Coastal Characterization</h3>
                                <p style={{ fontSize: '13px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '12px' }}><strong style={{ color: 'var(--dark-gray)' }}>Scope:</strong> Rotary drilling from floating platform for large-scale remediation plan.</p>
                                <p style={{ fontSize: '13.5px', color: 'var(--summit-red)', fontWeight: 700, marginBottom: '6px' }}>Results</p>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                ...
                < div className="page" style={{ padding: '44px 56px 50px', background: 'linear-gradient(160deg, #fff 0%, #f4f6f8 100%)', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '4px' }}>Your next project deserves a drilling partner who's prepared, precise, and accountable. At Summit Drilling we show up with ownership, field-tested skill, and a commitment to giving you <strong style={{ color: 'var(--summit-blue)' }}>An Exceptional Experience.</strong></p>
                    <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '22px' }}>Whether you need environmental drilling, complex injections, utility clearance, or geophysical services, we're ready to help you move forward with confidence.</p>
                        ...
                        <div style={{ background: 'var(--dark-gray)', padding: '40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            {[
                                ...
                                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '16px' }}>
                                    ...
                                    <div>
                                        <p style={{ fontSize: '14px', color: 'var(--summit-red)', fontWeight: 700, marginBottom: '2px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>{item.label}</p>
                    ...
                    <div style={{ border: '1px solid rgba(0,48,135,0.12)', borderRadius: '14px', padding: '18px 22px', background: 'rgba(0,48,135,0.03)' }}>
                        <h4 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '15px', color: 'var(--summit-red)', marginBottom: '6px' }}>Let's Build Something Together.</h4>
                        <p style={{ fontSize: '14px', color: 'var(--medium-gray)', lineHeight: 1.6, marginBottom: '8px' }}>Reach out today and let's talk about how we can help you meet your site goals safely, efficiently, and without compromise.</p>
                ...
                < div className="page" style={{ background: '#fff', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 2, marginTop: '48px', textAlign: 'left', width: '78%' }}>
                        ...
                        <h1 style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 800, fontSize: '52px', color: 'var(--summit-red)', letterSpacing: '-1.5px', lineHeight: 1, marginBottom: '14px' }}>Thank You</h1>
                        <div style={{ display: 'flex', gap: '8px' }}>
                            <div style={{ width: '72px', height: '6px', background: 'var(--summit-red)', borderRadius: '4px' }}></div>
                    ...
                    <div style={{ position: 'absolute', bottom: '60px', right: '60px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '15px', zIndex: 2 }}>
                        <div style={{ width: '120px', height: '3px', background: 'var(--summit-red)' }}></div>
