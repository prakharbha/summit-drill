            ...
            for (let i = 0; i < pages.length; i++) {
                ...
                const canvas = await html2canvas(page, {
                    ...
                    onclone: (clonedDoc) => {
                        ...
                        // Scope cloned images to the same page so image indexes remain aligned.
                        const clonedPage = clonedDoc.querySelectorAll<HTMLElement>('.soq-page')[i];
                        const clonedImages = clonedPage ? Array.from(clonedPage.querySelectorAll('img')) : [];
