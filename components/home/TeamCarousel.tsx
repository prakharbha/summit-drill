...
const TEAM_MEMBERS = [
    ...
    { id: 11, name: "John Passananti", title: "Compliance Officer", image: "/images/team/john-passananti-compliance-officer.png" },
    { id: 12, name: "Juan Diaz", title: "Fleet Director", image: "/images/team/juan-diaz-fleet-director.png" },
    { id: 13, name: "Trevor Quinn", title: "Director of IT", image: "/images/team/trevor-quinn-director-it.webp" },
    ...
    { id: 24, name: "Brian Moriarty", title: "Project Manager", image: "/images/team/brian-moriarty-project-manager.webp" },
    { id: 25, name: "Dustin Lutz", title: "General Manager", image: "/images/contact/dustin-lutz.webp" },
    { id: 26, name: "Nick King", title: "Project Manager", image: "/images/team/nick-king.webp" },
    { id: 27, name: "Brian Lombardo", title: "Regional Operations Manager", image: "/images/team/brian-lombardo-regional-operations-manager.webp" },
    { id: 28, name: "Chad Campbell", title: "VP of Operations, Florida", image: "/images/team/chad-campbell-vp-operations-florida.webp" },
    { id: 29, name: "Greg Campbell", title: "Permitting and Compliance Manager", image: "/images/team/greg-campbell-permitting-compliance-manager.webp" },
    { id: 30, name: "Jon Berntsen", title: "Remediation Operations Manager", image: "/images/team/jon-berntsen-remediation-operations-manager.webp" },
    { id: 54, name: "James Henderson", title: "Remediation Manager", image: "/images/team/james-henderson-remediation-manager.webp" },
    { id: 31, name: "Shannon Martin", title: "Business Manager, Florida", image: "/images/team/shannon-martin-business-manager-florida.webp" },
    { id: 32, name: "Christian Tormen", title: "Driller", image: "/images/team/christian-tormen-driller.webp" },
    { id: 33, name: "Matt Jelinski", title: "Driller", image: "/images/team/matt-jelinski-driller.webp" },
    { id: 34, name: "Barrie Woodington", title: "Driller", image: "/images/team/barrie-woodington-driller.webp" },
    { id: 35, name: "Bo Crandell", title: "Driller", image: "/images/team/bo-crandell-driller.webp" },
    { id: 36, name: "Brad Frace", title: "Driller", image: "/images/team/brad-frace-driller.webp" },
    { id: 37, name: "Chris Smolda", title: "Driller", image: "/images/team/chris-smolda-driller.webp" },
    { id: 38, name: "Devan Albert", title: "Driller", image: "/images/team/devan-albert-driller.webp" },
    { id: 39, name: "Dezmond Boyce", title: "Driller", image: "/images/team/dezmond-boyce-driller.webp" },
    { id: 40, name: "Fred Kushner", title: "Driller", image: "/images/team/fred-kushner-driller.webp" },
    { id: 41, name: "Jeremy Logel", title: "Driller", image: "/images/team/jeremy-logel-driller.webp" },
    { id: 42, name: "Justin Verba", title: "Driller", image: "/images/team/justin-verba-driller.webp" },
    { id: 43, name: "Kevin Barber", title: "Driller", image: "/images/team/kevin-barber-driller.webp" },
    { id: 44, name: "Patrick Shine", title: "Driller", image: "/images/team/patrick-shine-driller.webp" },
    { id: 45, name: "Robert Kimley", title: "Driller", image: "/images/team/robert-kimley-driller.webp" },
    { id: 46, name: "Tom McNally", title: "Driller", image: "/images/team/tom-mcnally-driller.webp" },
    { id: 47, name: "William Shinn", title: "Driller", image: "/images/team/william-shinn-driller.webp" },
    { id: 48, name: "Connor Storms", title: "Remediation Foreman", image: "/images/team/connor-storms-remediation-foreman.webp" },
    { id: 55, name: "Morvin Coronado Chacon", title: "Site Lead Equipment Operator", image: "/images/team/morvin-coronado-chacon-site-lead-equipment-operator.webp" },
    { id: 49, name: "Jonathan Emers", title: "Remediation Project Manager", image: "/images/team/jonathan-emers-remediation-project-manager.webp" },
    { id: 50, name: "Matthew Dyson", title: "Remediation Technician II", image: "/images/team/matthew-dyson-remediation-technician-ii.webp" },
    { id: 51, name: "Michael Bess Sr.", title: "Remediation Site Manager", image: "/images/team/michael-bess-sr-remediation-site-manager.webp" },
    { id: 52, name: "Randall Barney", title: "Remediation Supervisor", image: "/images/team/randall-barney-remediation-supervisor.webp" },
];
