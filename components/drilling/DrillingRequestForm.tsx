...
import { CloudUpload, Calendar } from "lucide-react";
            ...
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-end">
                    ...
                    <div className="lg:col-span-1">
                        <Button
                            size="lg"
                            className="w-full bg-[#1a365d] hover:bg-[#132845] text-white font-bold italic text-xl py-8 shadow-xl border-2 border-[#1a365d] hover:border-white/20"
                        >
                            Submit Project
                        </Button>
                    </div>
